...
\item
  ...
  \item
    ...
    posterior distribution of ( \beta\_\{\text{vendor}\} ) helps
...
\item
  ...
  \item
    ...
    \tightlist
    \item
      ( \beta\_\{\text{vendor}\} ): Reflects the expectation that most
      vendor effects are close to zero, with some deviations.
    \item
      ( \beta\_\{\text{month}\} ): Captures small but meaningful
      seasonal effects.
    \item
      ( \beta\_\{\text{old\_price}\} ): Represents the assumption that
...
\item
  ...
  \item
    ...
    interval for ( \beta\_\{\text{old\_price}\} ) of ({[}0.8, 1.2{]})
...
\caption{\label{tbl-modelresults}Explanatory model based on strawberry
prices}
...
\toprule
& strawberry price model \\ \midrule %% TinyTableHeader
(Intercept)       & \num{1.52}        \\
& (\num{0.66})      \\
vendorLoblaws     & \num{-0.09}       \\
& (\num{0.63})      \\
...
effect. For instance, the prior for (\beta\emph{\{\text{vendor}\})
...
95\% credible interval for (\beta}\{\text{old\_price}\}) indicates the
...
current\_price & 238 & 0 & 7.8 & 12.7 & 0.0 & 5.0 & 290.0 & \includegraphics[height=1em]{tinytable_assets/idmt8er0r82vj37ek89zop.png} \\
old\_price & 200 & 0 & 6.1 & 4.3 & 0.4 & 5.4 & 348.0 & \includegraphics[height=1em]{tinytable_assets/ido1q3pnzjq4gbr9teqt8b.png} \\
month & 8 & 0 & 8.9 & 1.6 & 4.0 & 9.0 & 11.0 & \includegraphics[height=1em]{tinytable_assets/idx5eyfzffe0ymhqp3okzw.png} \\
vendor & N & \% &  &  &  &  &  &  \\
Galleria & 400 & 0.9 &  &  &  &  &  &  \\
Loblaws & 4595 & 10.2 &  &  &  &  &  &  \\
Metro & 15819 & 35.3 &  &  &  &  &  &  \\
...
(\beta\_\{\text{vendor}\}) assumes no extreme pricing differences
